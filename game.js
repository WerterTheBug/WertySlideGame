...
class Game {
    ...
    createMenuUI() {
        ...
        this.menuButtons = [
            ...
            new Button("SHOP", cx, startY + spacing, btnW, btnH, () => this.openShop(), "outline"),
            new Button("INFO", cx, startY + spacing * 2, btnW, btnH, () => { this.state = STATE_INFO; }, "outline")
        ];
    ...
    draw() {
        ...
        if (this.state === STATE_MENU) {
            ...
            this.drawTextCentered(`PRACTICE SCORE: ${this.dataManager.data.high_level_practice}`, 18, cText, -70);
            ...
            this.drawTextCentered("SLIDE - A fast-paced maze puzzle game", 14, cText, -140);
            this.drawTextCentered("Use arrow keys or WASD to slide", 12, cText, -110);
            this.drawTextCentered("Reach the green goal before the lava reaches you!", 12, cText, -80);
            this.drawTextCentered("Collect cosmetics and unlock high-tier skins", 12, cText, -40);
            this.drawTextCentered("Press R to restart a level in practice mode", 12, cText, -10);
            this.drawTextCentered("Press SPACE or ESC to go back", 12, cBorder, 50);
